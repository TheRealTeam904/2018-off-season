...
public class Robot extends IterativeRobot {
	...
	public void CenterAutonRight() {
		...
		drive (0,0);
		while ((rightMotors[0].getSelectedSensorPosition(0) > -2178) && (rightMotors[0].getSelectedSensorPosition(0) < 13072)) {
			drive(-0.25,0);
			SmartDashboard.putNumber("encoderLeft", leftMotors[0].getSelectedSensorPosition(0));
			SmartDashboard.putNumber("encoderRight", rightMotors[0].getSelectedSensorPosition(0));
		}  
		drive (0,0);
		while (( rightMotors[0].getSelectedSensorPosition(0) < 35254) && (leftMotors[0].getSelectedSensorPosition(0) < 65754)) {
			drive(0,-0.25);
			arms.set(-.2);
			SmartDashboard.putNumber("encoderLeft", leftMotors[0].getSelectedSensorPosition(0));
			SmartDashboard.putNumber("encoderRight", rightMotors[0].getSelectedSensorPosition(0));
		...
		drive (0,0);
		arms.set(0);
		while (65754 >= rightMotors[0].getSelectedSensorPosition(0)) {
			drive(0.25,0);
			SmartDashboard.putNumber("encoderLeft", leftMotors[0].getSelectedSensorPosition(0));
			SmartDashboard.putNumber("encoderRight", rightMotors[0].getSelectedSensorPosition(0));
		}
		drive(0,0);
		while((rightMotors[0].getSelectedSensorPosition(0) < 128150) && (leftMotors[0].getSelectedSensorPosition(0) < 82400)) {
			drive(0,-0.25);
			SmartDashboard.putNumber("encoderLeft", leftMotors[0].getSelectedSensorPosition(0));
			SmartDashboard.putNumber("encoderRight", rightMotors[0].getSelectedSensorPosition(0));
		}
		drive (0,0);
		while ((rightMotors[0].getSelectedSensorPosition(0) >= 128150) && (leftMotors[0].getSelectedSensorPosition(0) >= 117256)) {
	...
	*/
	public void CenterAutonLeft() {
		...
		drive (0,0);
		while ((leftMotors[0].getSelectedSensorPosition(0) > -2178) && (leftMotors[0].getSelectedSensorPosition(0) < 13072)) {
			drive(0.25,0);
			SmartDashboard.putNumber("encoderLeft", leftMotors[0].getSelectedSensorPosition(0));
			SmartDashboard.putNumber("encoderRight", rightMotors[0].getSelectedSensorPosition(0));
		}  
		...
		drive (0,0);
		while ((leftMotors[0].getSelectedSensorPosition(0) >= 128150) && (rightMotors[0].getSelectedSensorPosition(0) >= 117256)) {
			grabber.set(DoubleSolenoid.Value.kOff);
			SmartDashboard.putNumber("encoderLeft", leftMotors[0].getSelectedSensorPosition(0));
			SmartDashboard.putNumber("encoderRight", rightMotors[0].getSelectedSensorPosition(0));
		}
	...
	public void LeftSideScale() {
		...
		drive(0,0);
		while((leftMotors[0].getSelectedSensorPosition(0) > 235335) || (rightMotors[0].getSelectedSensorPosition(0) > 204835)) {
			grabber.set(DoubleSolenoid.Value.kOff);
		}
		drive(0,0);
	}
	...
	public void RightSideScale() {
		...
		drive(0,0);
		while((rightMotors[0].getSelectedSensorPosition(0) > 235335) || (leftMotors[0].getSelectedSensorPosition(0) > 204835)) {
			grabber.set(DoubleSolenoid.Value.kOff);
		}
		drive(0,0);
	}
	...
	// Driver xBox Controller input, axes for driving, and gear shifting
